			...
			if(cmd.getName().equalsIgnoreCase("sethome")) {
				if(sender instanceof Player) {
					...
					if(args.length == 1) {
						...
						Main.getInstance().getConfig().set("home." + p.getUniqueId() + "." + args[0] + ".z", p.getLocation().getZ());
						Main.getInstance().getConfig().set("home." + p.getUniqueId() + "." + args[0] + ".pitch", p.getEyeLocation().getPitch());
						Main.getInstance().getConfig().set("home." + p.getUniqueId() + "." + args[0] + ".yaw", p.getEyeLocation().getYaw());
