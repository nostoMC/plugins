package fr.djredstone.nosto.commands.claim;
        ...
        if (sender instanceof Player)
        {
            ...
            if(cmd.getName().equalsIgnoreCase("claim")) {
            	...
            	if (Main.getInstance().getConfig().contains("claim." + chunkID)) {
            		player.sendMessage("");
                	player.sendMessage("�cCe chunk est d�j� claim !");
            	...
            	if (Main.getInstance().getConfig().getString("claim." + chunkID).equals(player.getUniqueId().toString())) {
            		...
            		player.sendMessage("");
            		player.sendMessage("�cVous ne poss�dez pas ce chunk !");
            	}
            }
            } else {
            	player.sendMessage("");
            	player.sendMessage("�cLes claim sont seulement autoris�s dans les mondes : �6�lSurvie");
            }
        }
        return true;
    }
