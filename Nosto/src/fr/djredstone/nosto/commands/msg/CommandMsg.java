package fr.djredstone.nosto.commands.msg;
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(args.length == 0) {
				...
				target.sendMessage("");
				target.sendMessage("�6�l" + player.getName() + " �evous � poke !");
				...
				player.sendMessage("");
				player.sendMessage("�eVous avez envoyer : �a" + argsMessage.toString() + " �e� �6�l" + target.getName());
				target.sendMessage("");
				target.sendMessage("�eVous avez re�u un message de �6�l" + player.getName() + "�e : �a" + argsMessage.toString());
